    ...
    return inquirer
        .prompt([
            ...
            if(data.shape === 'Triangle') {
                ...
                fs.writeFile('triangle.svg', triangle.render(), (err) => {err ? console.error(err) : console.log('\x1b[32mGenerated triangle.svg\x1b[0m')}) // generates the file, console logs in green text
